...
BEGIN_MESSAGE_MAP(CMFCsodickApp, CWinApp)
...
// 僅有的一個 CMFCsodickApp 物件

CMFCsodickApp theApp;


// CMFCsodickApp 初始設定

BOOL CMFCsodickApp::InitInstance()
{
